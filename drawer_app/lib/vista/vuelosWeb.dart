...
class VuelosWeb extends StatelessWidget {
  static String routeName = "/Actividades list";
      ...
      body: Container(
        child: Center(
          child: FutureBuilder<List<bitacora>>(
              ...
              future: datosWeb
                  .fetchVuelos(), // Lista de todos de los registros extraidos del servicio web en formato map
              builder: (BuildContext context,
                  AsyncSnapshot<List<bitacora>> snapshot) {
                List<Widget> children;
                if (snapshot.hasData) {
                  children = snapshot
                      .data // Lista de los registros extraidos del servicio web convertidos en formato List<ListItem>
